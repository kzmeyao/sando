...
images:
  ...
  - file: '2'
    alt: Fog among the trees
    caption: The morning after spending the first night at Hunter's Camp. The fog was still receding as the sun came up.
  - file: '3|4'
    alt: Purple-pink wildflowers|A waterfall with turquoise waters.
    caption: Wildflowers and waterfalls were refreshing sights along the way.
  - file: '5'
    alt: Tall trees towering overhead
    caption: A stretch of forest with tall trees provided much-needed shade for us near the end of the trail. One final push!
  - file: '6'
    alt: Granite rocks with a waterfall in the back
    caption: We had to hike up that? You can barely make out Grizzly Fall in the distance.
  - file: '7'
    alt: A waterfall dispensing out of a wall of granite
    caption: Grizzly Fall. Not as much flow as I would have wanted, but it was the end of the summer, so couldn't complain.
  - file: '8'
    alt: A glacial lake in front of a granite peak.
    caption: Grizzly Lake, deep enough for a lake monster.
  - file: '9'
    alt: Lake shore with lots of trees sticking out
    caption: The lake was sparkling under the sun, perfectly capturing the summer vibes.
  - file: '10|11'
    alt: Turquoise-blue lake waters|Yellow wildflowers
    caption: It was like another world there sitting next to the lake.
path: '/posts/2015-grizzly-lake-california'
